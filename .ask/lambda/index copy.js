...
const LaunchRequestHandler = {
    ...
    async handle(handlerInput) {
        ...
        const ssml = "Welcome to the kingdom of Nilfguard <break time='1s'/> I am the seer from halls of valhalla <break time='1s'/> Say reveal, to know what your future holds";
    ...
    handle(handlerInput) {
       ...
       //const speakOutput = `Let me roll the runes for you. O Freya. Tell this human their fortune. The gods have picked ${tarotCard}. Thank the Gods and go in peace my child.`;
        ...
        return handlerInput.responseBuilder
            ...
            .reprompt('Say reveal to ask the gods for another card')
            .getResponse();
    }
};


const DisplayDetailedTarotIntent = {
  canHandle(handlerInput) {
    const request = handlerInput.requestEnvelope.request;
      return request.type === 'Alexa.Presentation.APL.UserEvent'
          && request.arguments[0] === 'tarotDetail';
          
  },
  handle(handlerInput) {
      // *** add this line ***
      //const randomCard = handlerInput.requestEnvelope.request.arguments[1];
      let randomCard = Math.floor(Math.random() * tarots.length);
      const tarotCard = tarots[randomCard];
      const tarotImg = tarot_img[randomCard];
     //const speakOutput = `Let me roll the runes for you. O Freya. Tell this human their fortune. The gods have picked ${tarotCard}. Thank the Gods and go in peace my child.`;
        ...
        return handlerInput.responseBuilder.speak("Welcome")
  }
};
